...
class TestCoxPoints3Components(unittest.TestCase):
    ...
    def test_generate_cox_points_2(self):
        """ Moves the first coordinate of the second row to a few locations. This is
            an edge case, as the starting values is 1 """
        locs = [0, 0.3, 1]
    ...
    def test_generate_cox_points_3(self):
        """ Moves the second coordinate of the second row to a few locations along a grid. This
            is an edge case, as the starting value is 0 """
        locs = [0, 0.3, 1]
...
class TestCoxPoints2Components(unittest.TestCase):
    """ Tests the generation of points along the Cox effect direction in 2-component
        simplex space """
